...
// references (refersTo) for every record, for the TGM subject crosswalk.
// (Genre/format is already in index.json `c`; subjects were never harvested.)
//
...
// type tag; only Category titles feed the TGM crosswalk (topical subjects) —
// Person/Place/Organisation are named entities, kept for the record but not
// crosswalked.
//
